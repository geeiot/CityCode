...
namespace Main.Helper
{
    class HttpHelper
    {
        ...
        public bool TestApiServerStatus()
        {
            var urls = new string[] { "http://api.geeiot.net", };
            int count = 0;
        ...
        /// <returns></returns>  
        public string HttpResponseGetString(string url, string getData = null, int? timeout = null, string userAgent = null,
        ...
        /// <param name="cookies">随同HTTP请求发送的Cookie信息，如果不需要身份验证可以为空</param>  
        /// <returns></returns>  
        public string HttpResponsePostString(string url, string postData = null,
        ...
        /// <param name="cookies">随同HTTP请求发送的Cookie信息，如果不需要身份验证可以为空</param>  
        /// <returns></returns>  
        private HttpWebResponse HttpResponseGet(string url, string getData = null, int? timeout = null, string userAgent = null,
            CookieCollection cookies = null, string method = "GET")
        {
        ...
        /// <param name="cookies">随同HTTP请求发送的Cookie信息，如果不需要身份验证可以为空</param>  
        /// <returns></returns>  
        private HttpWebResponse HttpResponsePost(string url, string postData = null,
            Encoding requestEncoding = null, int? timeout = null, string userAgent = null,
            CookieCollection cookies = null, bool sendJson = false, bool sendXml = false)
        {
            if (string.IsNullOrEmpty(url))
